...
project = u'Fragment Hotspot Maps'
...
html_logo='https://github.com/prcurran/fragment_hotspot_maps/tree/master/hotspots/img/logo_test.png'
html_favicon='https://github.com/prcurran/fragment_hotspot_maps/tree/master/hotspots/img/logo_test.png'
