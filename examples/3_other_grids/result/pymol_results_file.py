...
if dirpath:
    f = join(dirpath, "label_threshold_2.mol2")
else:
    f = "label_threshold_2.mol2"

cmd.load(f, 'label_threshold_2')
cmd.hide('everything', 'label_threshold_2')
cmd.label("label_threshold_2", "name")
