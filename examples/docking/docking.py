...
class Organiser(argparse.ArgumentParser):
    ...
    def dock(self):
        ...
        # download protein
        PDBResult("1hcl").download(self.temp)
        protein = Protein.from_file(os.path.join(self.temp, "1hcl.pdb"))
        ...
        cavs = Cavity.from_pdb_file(os.path.join(self.temp, "1hcl.pdb"))
        c = {}
        for cav in cavs:
