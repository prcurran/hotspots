...
donor_projected_point_0 = [COLOR, 0.0, 0.0, 1.0] +  [ALPHA, 1.0] + [SPHERE, float(29.3), float(42.9), float(34.8), float(0.5)]

cmd.load_cgo(donor_projected_point_0, "donor_projected_point_0_obj", 1)
donor_projected_projection_0 = [COLOR, 0.6, 0.6, 1.0] +  [ALPHA, 1.0] + [SPHERE, float(26.7), float(43.7), float(34.0), float(0.5)]
...
donor_projected_point_1 = [COLOR, 0.0, 0.0, 1.0] +  [ALPHA, 1.0] + [SPHERE, float(26.4), float(43.0), float(31.0), float(0.5)]
...
acceptor_projected_point_2 = [COLOR, 1.0, 0.0, 0.0] +  [ALPHA, 1.0] + [SPHERE, float(27.6), float(40.8), float(35.0), float(0.5)]

cmd.load_cgo(acceptor_projected_point_2, "acceptor_projected_point_2_obj", 1)
acceptor_projected_projection_2 = [COLOR, 1.0, 0.6, 0.6] +  [ALPHA, 1.0] + [SPHERE, float(27.3), float(43.2), float(33.5), float(0.5)]
...
acceptor_projected_point_3 = [COLOR, 1.0, 0.0, 0.0] +  [ALPHA, 1.0] + [SPHERE, float(28.8), float(39.6), float(36.4), float(0.5)]

cmd.load_cgo(acceptor_projected_point_3, "acceptor_projected_point_3_obj", 1)
acceptor_projected_projection_3 = [COLOR, 1.0, 0.6, 0.6] +  [ALPHA, 1.0] + [SPHERE, float(26.9), float(37.6), float(36.3), float(0.5)]
...
acceptor_projected_point_4 = [COLOR, 1.0, 0.0, 0.0] +  [ALPHA, 1.0] + [SPHERE, float(31.5), float(43.1), float(34.6), float(0.5)]

cmd.load_cgo(acceptor_projected_point_4, "acceptor_projected_point_4_obj", 1)
acceptor_projected_projection_4 = [COLOR, 1.0, 0.6, 0.6] +  [ALPHA, 1.0] + [SPHERE, float(33.8), float(44.4), float(33.4), float(0.5)]
...
acceptor_projected_point_5 = [COLOR, 1.0, 0.0, 0.0] +  [ALPHA, 1.0] + [SPHERE, float(31.5), float(43.1), float(34.6), float(0.5)]

cmd.load_cgo(acceptor_projected_point_5, "acceptor_projected_point_5_obj", 1)
acceptor_projected_projection_5 = [COLOR, 1.0, 0.6, 0.6] +  [ALPHA, 1.0] + [SPHERE, float(31.9), float(41.0), float(36.2), float(0.5)]
...
acceptor_projected_point_6 = [COLOR, 1.0, 0.0, 0.0] +  [ALPHA, 1.0] + [SPHERE, float(30.2), float(42.6), float(31.2), float(0.5)]
...
acceptor_projected_point_7 = [COLOR, 1.0, 0.0, 0.0] +  [ALPHA, 1.0] + [SPHERE, float(29.0), float(44.3), float(29.8), float(0.5)]
...
ring_planar_projected_point_8 = [COLOR, 0.33, 1.0, 0.0] +  [ALPHA, 1.0] + [SPHERE, float(32.4), float(46.7), float(35.6), float(0.5)]

cmd.load_cgo(ring_planar_projected_point_8, "ring_planar_projected_point_8_obj", 1)
ring_planar_projected_projection_8 = [COLOR, 0.73, 1.0, 0.6] +  [ALPHA, 1.0] + [SPHERE, float(33.1), float(44.0), float(35.9), float(0.5)]

cmd.load_cgo(ring_planar_projected_projection_8, "ring_planar_projected_projection_8_obj", 1)
...
ring_planar_projected_point_9 = [COLOR, 0.33, 1.0, 0.0] +  [ALPHA, 1.0] + [SPHERE, float(32.4), float(46.7), float(35.6), float(0.5)]

cmd.load_cgo(ring_planar_projected_point_9, "ring_planar_projected_point_9_obj", 1)
ring_planar_projected_projection_9 = [COLOR, 0.73, 1.0, 0.6] +  [ALPHA, 1.0] + [SPHERE, float(31.7), float(49.4), float(35.2), float(0.5)]
...
cmd.load("ring_planar_projected.grd", "ring_planar_projected_grid")
cmd.isosurface(name="surface_ring_planar_projected", map="ring_planar_projected_grid", level="1")
